  ...
  return (
    <div className="w-64 h-96 perspective">
      ...
      >
        ...
        {/* Back Face */}
        <div className="absolute w-full h-full backface-hidden bg-green-100 border-4 border-green-500 text-green-900 rounded-2xl rotateY-180 flex items-center justify-center p-4">
